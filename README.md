...
#### Класс OrderModel
Класс для хранения заказа и валидации данных
Поля класса:
- data:Record<string, string> - отвечает за хранение данных заказа
...
Методы: 
- isValid():boolean - проверяет валидность данных
- getData():Record<string, string> - возвращает объект с данными заказа
- getErrors:Record<string, string> - возвращает объект с ошибками
...
Методы:
- inputChange - отражение изменения полей формы
